 ...
 *  	    - ʿ : Servlet API 
 *  	: ȭ鿡  Model  org.springframework.ui.Model 
 *      
...
//@Controller
//@RequestMapping("/user")
public class UserController_beforeTransactionApply {
	...
	///Constructor
	public UserController_beforeTransactionApply(){
	...
	public String logon(Model model){
		...
		//==> Client    Message  
		String message = "[ logon() ] ̵,н 3̻ Էϼ.";
	...
	public String logout( Model model , HttpSession session){
		...
		//==> Client    Message  
		String message = "[Logout()] ̵,н 3̻ Էϼ.";
